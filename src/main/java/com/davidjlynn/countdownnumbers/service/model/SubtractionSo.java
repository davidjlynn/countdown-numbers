...
@Getter
@AllArgsConstructor
public class SubtractionSo implements OperationSo{

  private final OperationSo number1;
  private final OperationSo number2;

  public SubtractionSo(Integer number1, OperationSo operation2){
    this(new NumberSo(number1), operation2);
  }

  public SubtractionSo(Integer number1, Integer number2){
